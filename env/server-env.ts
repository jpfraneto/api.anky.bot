...
const envSchema = object({
    ...
    VIBRA_BOT_WARPCAST_API_KEY: string("VIBRA_BOT_WARPCAST_API_KEY is required"),
    JPFRANETO_WARPCAST_API_KEY: string("JPFRANETO_WARPCAST_API_KEY is required"),
  ...
  export const {
    ...
    AIRSTACK_API_KEY,
    VIBRA_BOT_WARPCAST_API_KEY,
    JPFRANETO_WARPCAST_API_KEY,
